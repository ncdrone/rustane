//! Convert Kimi-K2 bf16 safetensors → rustane format.
//!
//! Produces:
...
//!
//! K2 is bf16 (not FP8 like V3). The fp8_tensor_to_f32 path falls back to
//! tensor_to_f32 automatically when it encounters bf16 dtype.
//!
//! Usage:
//!   cargo run -p moe-infer --release --bin convert_k2 -- \
//!     --model-dir weights/kimi-k2 \
//!     --output-dir weights/rustane-k2 \
//!     [--max-layers N]
...
// K2 config (from moonshotai/Kimi-K2-Instruct config.json)
const HIDDEN: usize = 7168;
const NUM_LAYERS: usize = 61;
const NUM_HEADS: usize = 64;       // K2=64 (V3=128)
const NOPE_DIM: usize = 128;
const V_HEAD_DIM: usize = 128;
const KV_LORA_RANK: usize = 512;
const MOE_INTER: usize = 2048;
const NUM_EXPERTS: usize = 384;    // K2=384 (V3=256)
const GROUP_SIZE: usize = 128;
const FIRST_K_DENSE: usize = 1;    // K2=1 (V3=3)
